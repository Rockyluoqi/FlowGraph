...
import com.ROCKY_IMAGEBrowser.LazyScrollView.OnScrollListener;
import com.ROCKY_IMAGEBrowser.FlowView;
...
public class MainActivity extends Activity {
    ...
    private void AddImage(final String filename, int rowIndex, final int id) {
